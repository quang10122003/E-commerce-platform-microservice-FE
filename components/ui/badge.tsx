...
const badgeVariants = cva(
  "inline-flex items-center gap-1 font-semibold font-heading transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none",
  {
    variants: {
      variant: {
